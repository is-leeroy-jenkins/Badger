...
namespace Syncfusion.Themes.Dark.WPF
{
    /// <exclude/>
    public class DarkSkinHelper : SkinHelper
    {
        ...
        {
            string rootStylePath = "/Syncfusion.Themes.Dark.WPF;component/";
    ...
    /// </summary>
    public class DarkThemeSettings: IThemeSetting
    {
        /// <summary>
        /// Constructor to create an instance of DarkThemeSettings.
        /// </summary>
        ...
        /// <code language="C#">
        /// <![CDATA[
        /// DarkThemeSettings themeSettings = new DarkThemeSettings();
		/// themeSettings.Palette = FluentPalette.PinkRed;
        /// SfSkinManager.RegisterThemeSettings("Dark", themeSettings);
        /// ]]>
        /// </code>
        /// </example>
        /// <remarks>
		...
		/// <code language="C#">
		/// <![CDATA[
		/// DarkThemeSettings darkThemeSettings = new DarkThemeSettings();
		/// darkThemeSettings.HeaderFontSize = 16;
		/// SfSkinManager.RegisterThemeSettings("Dark", darkThemeSettings);
		/// ]]>
		/// </code>
		/// </example>
		...
		/// <![CDATA[
		/// DarkThemeSettings darkThemeSettings = new DarkThemeSettings();
		/// darkThemeSettings.SubHeaderFontSize = 14;
		/// SfSkinManager.RegisterThemeSettings("Dark", darkThemeSettings);
		/// ]]>
		/// </code>
		/// </example>
		...
		/// <![CDATA[
		/// DarkThemeSettings darkThemeSettings = new DarkThemeSettings();
		/// darkThemeSettings.TitleFontSize = 14;
		/// SfSkinManager.RegisterThemeSettings("Dark", darkThemeSettings);
		/// ]]>
		/// </code>
		/// </example>
		...
		/// <![CDATA[
		/// DarkThemeSettings darkThemeSettings = new DarkThemeSettings();
		/// darkThemeSettings.SubTitleFontSize = 12;
		/// SfSkinManager.RegisterThemeSettings("Dark", darkThemeSettings);
		/// ]]>
		/// </code>
		/// </example>
		...
		/// <![CDATA[
		/// DarkThemeSettings darkThemeSettings = new DarkThemeSettings();
		/// darkThemeSettings.BodyFontSize = 12;
		/// SfSkinManager.RegisterThemeSettings("Dark", darkThemeSettings);
		/// ]]>
		/// </code>
		/// </example>
		...
		/// <![CDATA[
		/// DarkThemeSettings darkThemeSettings = new DarkThemeSettings();
		/// darkThemeSettings.Body AltFontSize = 10;
		/// SfSkinManager.RegisterThemeSettings("Dark", darkThemeSettings);
		/// ]]>
		/// </code>
		/// </example>
		...
		/// <![CDATA[
		/// DarkThemeSettings darkThemeSettings = new DarkThemeSettings();
		/// darkThemeSettings.FontFamily = new FontFamily("Callibri");
		/// SfSkinManager.RegisterThemeSettings("Dark", darkThemeSettings);
		/// ]]>
		/// </code>
		/// </example>
		...
		/// <![CDATA[
		/// DarkThemeSettings darkThemeSettings = new DarkThemeSettings();
		/// darkThemeSettings.PrimaryBackground = Brushes.Red;
		/// SfSkinManager.RegisterThemeSettings("Dark", darkThemeSettings);
		/// ]]>
		/// </code>
		/// </example>
		...
		/// <![CDATA[
		/// DarkThemeSettings darkThemeSettings = new DarkThemeSettings();
		/// darkThemeSettings.PrimaryForeground = Brushes.AntiqueWhite;
		/// SfSkinManager.RegisterThemeSettings("Dark", darkThemeSettings);
		/// ]]>
		/// </code>
		/// </example>
